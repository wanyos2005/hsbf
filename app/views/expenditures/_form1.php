<div class="form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => $this->createUrl('expenditures/whichJournal'),
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-8 col-sm-12" style="width: 100%">
                <table style="width: 100%">
                    <tr>
                        <td><b>Journal :</b></td>
                        <td><?php echo CHtml::dropDownList('type', $type, Voteheads::incomeOrExpenditure()); ?></td>
        ...
        <div class="panel-footer clearfix">
            <button class="btn  btn-sm btn-primary" type="submit"><i class="icon-ok bigger-110"></i> <?php echo Lang::t('Genarate Journal') ?></button>
