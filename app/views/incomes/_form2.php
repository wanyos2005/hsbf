<div class="form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        ...
        'action' => $this->createUrl('expenditures/downloadBalanceSheet'),
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h3 class="panel-title">Balance Sheets</h3></div>
        ...
        <div class="panel-footer clearfix">
            <button class="btn  btn-sm btn-primary" type="submit"><i class="icon-ok bigger-110"></i> <?php echo Lang::t('Genarate Balance Sheet') ?></button>
