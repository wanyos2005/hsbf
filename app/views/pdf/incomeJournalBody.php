<table>
    ...
    <tr>
        ...
        <td style="display:table-cell; text-align:center; width:85px; height: 12px; border: 2px solid #000000">
            <font style="font-family: sans-serif; font-weight: normal" size="9">RECEIPT NO.</font>
        </td>
    ...
    <?php foreach ($incomes as $income): ?>
        <?php $endDate = substr($income->date, 8, 2) . ' ' . substr(Defaults::monthName(substr($income->date, 5, 2)), 0, 3) . ' ' . substr($income->date, 0, 4); ?>
        <tr>
