...
class SCalendar extends CWidget {
    ...
    private function createMarkup() {
        ...
        if (isset($this->_flat))
            $prop .= "flat            : '$this->_flat',\n";
        if (isset($this->_button))
            $prop .= "button          : '$this->_button',\n";
        if (isset($this->_ifFormat))
            $prop .= "ifFormat        : '$this->_ifFormat',\n";
        if (isset($this->_eventName))
            $prop .= "eventName       : '$this->_eventName',\n";
        if (isset($this->_firstDay))
            $prop .= "firstDay        :  $this->_firstDay,\n";
        if (isset($this->_daFormat))
            $prop .= "daFormat        : '$this->_daFormat',\n";
        if (isset($this->_displayArea))
            $prop .= "displayArea     : '$this->_displayArea',\n";
        if (isset($this->_singleClick))
            $prop .= "singleClick     :  '$this->_singleClick',\n";
        if (isset($this->dateStatusFunc))
            $prop .= "dateStatusFunc  : $this->dateStatusFunc,\n";
        if (isset($this->_weekNumbers))
            $prop .= "weekNumbers     :  '$this->_weekNumbers',\n";
        if (isset($this->_align))
            $prop .= "align           : '$this->_align',\n";
        if (isset($this->_range))
            $prop .= "range           :  $this->_range,\n";
        if (isset($this->_flatCallback))
            $prop .= "flatCallback    : $this->_flatCallback,\n";
        if (isset($this->_onSelect))
            $prop .= "onSelect        : $this->_onSelect,\n";
        if (isset($this->_onClose))
            $prop .= "onClose         : $this->_onClose,\n";
        if (isset($this->_onUpdate))
            $prop .= "onUpdate        : $this->_onUpdate,\n";
        if (isset($this->_date))
            $prop .= "date            : '$this->_date',\n";
        if (isset($this->_showsTime))
            $prop .= "showsTime       :  '$this->_showsTime',\n";
        if (isset($this->_timeFormat))
            $prop .= "timeFormat      :  $this->_timeFormat,\n";
        if (isset($this->_electric))
            $prop .= "electric        :  '$this->_electric',\n";
        if (isset($this->_position))
            $prop .= "position        :  $this->_position,\n";
        if (isset($this->_cache))
            $prop .= "cache           :  '$this->_cache',\n";
        if (isset($this->_showOthers))
            $prop .= "showOthers      :  '$this->_showOthers',\n";
        if (isset($this->_step))
            $prop .= "step            : $this->_step,\n";
